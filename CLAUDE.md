...
| `uptimekumastuff/`           | Uptime-Kuma export/import (`SimpleKumaApi`): full state via Socket.IO API, Typer CLI |
...
- Single-stage build (sipstuff/PJSIP/piper were removed — sipstuff is now a standalone repo)
